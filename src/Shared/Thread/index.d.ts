...
declare namespace Thread {
	 ...
	 * @returns None.
	 */
	export function SpawnNow<T extends any[]>(func: (...args: T) => void, ...args: T): void;
	 ...
	 * @returns None.
	 */
	export function Spawn<T extends any[]>(func: (...args: T) => void, ...args: T): void;
	 ...
	 */
	export function Delay<T extends any[]>(waitTime: number, func: (...args: T) => void, ...args: T): RBXScriptConnection;
	 ...
	 */
	export function DelayRepeat<T extends any[]>(time: number, func: (...args: T) => void, ...args: T): void;
}
